...
var name = prompt('Enter the name of Pokemon');                      // The prompt() method will take Pokemon name as input.

var DetailOfPokemon = function(name, Pokemon) {                      // function Expression 
                                               
    for (var currentPokemon in Pokemon.pokemon) {                    // forin() loop, to loop through json data   
        if (Pokemon.pokemon[currentPokemon].name == name) {          // if() condition to check entered name is equal to name in the json data 
            var Detail = Pokemon.pokemon[currentPokemon];
            var j = 1;
            break;
        }
    ...
    if (j == 1) {                                                    // if() condition checks for j value is equal to 1, which is from previous if() loop is true then j value is declared as 1.
        alert(Detail);
        console.log(Detail);
    } else {                                                         // if j!=0 ,Pokemon Not found.
        alert("Pokemon Not Found");
    }

}

DetailOfPokemon(name, Pokemon);                                      // calling the Function. 